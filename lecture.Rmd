...
keywords: rnaseq, bioinformatics, course
output: 
...
# enable fontawesome in HTML based bookdown outputs
...
- [Grid Graphics](#graphics-ggplot-1)
...
* Package management using `packrat` (RStudio integrated) or `renv`
