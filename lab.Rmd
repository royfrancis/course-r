...
date: "`r paste0('<b>Roy Francis</b> • ',format(Sys.time(),'%d-%b-%Y'))`"
output:
...
<img src="images/ggplot2-exploratory.png" style="padding:15px; max-width:600px">
...
<img src="images/rmarkdown-wizards.png" style="padding:15px; max-width:600px">
...
<img src="images/storyset-helpful-sign.png" style="padding:15px; max-width:300px">
...
<img src="images/storyset-learning.png" style="padding:15px; max-width:300px">
...
<span><span class="small">Graphics from </span><img src="./images/freepik.jpg" style="max-height:20px; vertical-align:middle;"></span>
<hr style="margin-top:2px; margin-bottom:10px;">
<span><b>`r format(Sys.Date(),"%Y")`</b> • Roy Francis • [SciLifeLab](https://www.scilifelab.se/) • [NBIS](https://nbis.se/)</span>
</div>
