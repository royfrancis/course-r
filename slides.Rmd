...
- Press <kbd>Esc</kbd> to escape from `+` to `>`
...
<span><span class="small">Graphics from </span><img src="./images/freepik.jpg" style="max-height:20px; vertical-align:middle;"></span><br>
<span><b>`r format(Sys.Date(),"%Y")`</b> • Roy Francis • <a href="https://www.scilifelab.se/">SciLifeLab</a> • <a href="https://nbis.se/">NBIS</a></span>
</div>
